...
export const projectSections: Record<string, ProjectSectionsMap> = {
  ...
  "goblin-td": {
    ...
    development: {
      ...
      displayTitle: { en: "Development", es: "Desarrollo" },
      bodyHtml: { en: "<p dir=\"auto\">Development focused on the gameplay systems that connect goblin workers with construction, resource gathering, production, and defense. The goal was to keep these systems modular while making each worker action visible in the game world.</p>", es: "<p dir=\"auto\">El desarrollo se centró en los sistemas de juego que conectan a los duendes trabajadores con la construcción, la recolección de recursos, la producción y la defensa. El objetivo era mantener estos sistemas modulares y, al mismo tiempo, hacer visible cada acción de los trabajadores en el mundo del juego.</p>" },
      bodyMobileHtml: { en: "<p dir=\"auto\">Development focused on the gameplay systems that connect goblin workers with construction, resource gathering, production, and defense.</p>", es: "<p dir=\"auto\">El desarrollo se centró en los sistemas de juego que conectan a los duendes trabajadores con la construcción, la recolección de recursos, la producción y la defensa.</p>" },
      subsections: [
        {
          id: "KO9BLYXge",
          ...
          items: [
            {
              id: "mSNHgqZhI",
              displayTitle: { en: "01 · Construction System", es: "01 · Sistema de construcción" },
              bodyHtml: { en: "<p dir=\"auto\">Building placement connects grid validation, worker assignment, construction, activation, and UI feedback into a single flow.</p><p dir=\"auto\"><strong>Implementation focus</strong><br>Grid validation, worker assignment, construction states, building activation, and UI synchronization.</p>", es: "<p dir=\"auto\">La colocación de edificios conecta la validación de la cuadrícula, la asignación de trabajadores, la construcción, la activación y la respuesta de la interfaz en un único flujo.</p><p dir=\"auto\"><strong>Enfoque de la implementación</strong><br>Validación de la cuadrícula, asignación de trabajadores, estados de construcción, activación de edificios y sincronización de la interfaz.</p>" },
              badge: { en: "01", es: "01" },
            ...
            {
              id: "OYKY2LpOi",
              displayTitle: { en: "02 · Grid Placement", es: "02 · Colocación en la cuadrícula" },
              bodyHtml: { en: "<p dir=\"auto\">The placement system validates footprint size, tile occupancy, and buildable areas before allowing construction.</p><p dir=\"auto\"><strong>Implementation focus</strong><br>Grid validation, footprint variants, occupancy rules, and placement feedback.</p>", es: "<p dir=\"auto\">El sistema de colocación valida el tamaño de la huella, la ocupación de las casillas y las zonas edificables antes de permitir la construcción.</p><p dir=\"auto\"><strong>Enfoque de la implementación</strong><br>Validación de la cuadrícula, variantes de huella, reglas de ocupación y respuesta de colocación.</p>" },
              badge: { en: "02", es: "02" },
              icon: asset("si-placeholder.png"),
              order: 2,
            },
            {
              id: "Wk9mx9_Pf",
              displayTitle: { en: "03 · Goblin Assignment", es: "03 · Asignación de duendes" },
              bodyHtml: { en: "<p dir=\"auto\">Goblin workers can be assigned to construction, mining, farming, or defense tasks. The system tracks availability and updates each worker’s current role.</p><p dir=\"auto\"><strong>Implementation focus</strong><br>Worker availability, task assignment, movement, and state transitions.</p>", es: "<p dir=\"auto\">Los duendes trabajadores pueden asignarse a tareas de construcción, minería, cultivo o defensa. El sistema controla su disponibilidad y actualiza el rol actual de cada trabajador.</p><p dir=\"auto\"><strong>Enfoque de la implementación</strong><br>Disponibilidad de trabajadores, asignación de tareas, desplazamiento y transiciones de estado.</p>" },
              badge: { en: "03", es: "03" },
              icon: asset("si-placeholder.png"),
              order: 3,
            },
            {
              ...
              displayTitle: { en: "04 · Resource & Production System", es: "04 · Sistema de recursos y producción" },
              bodyHtml: { en: "<p dir=\"auto\">Mines and farms generate resources based on their active goblin assignments, connecting worker management with building and tech progression.</p><p dir=\"auto\"><strong>Implementation focus</strong><br>Production rates, worker slots, resource generation, and economy state.</p>", es: "<p dir=\"auto\">Las minas y las granjas generan recursos según los duendes asignados, conectando la gestión de trabajadores con la progresión de edificios y tecnologías.</p><p dir=\"auto\"><strong>Enfoque de la implementación</strong><br>Tasas de producción, puestos de trabajo, generación de recursos y estado de la economía.</p>" },
              badge: { en: "04", es: "04" },
              icon: asset("si-placeholder.png"),
              order: 4,
            },
