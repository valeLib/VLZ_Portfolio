...
export const projectSections: Record<string, ProjectSectionsMap> = {
      ...
      subsections: [
        {
          ...
          bodyHtml: { en: "<p dir=\"auto\">Development focused on connecting goblin workers with construction, resource gathering, and defense through modular gameplay systems.</p><p dir=\"auto\"><br class=\"trailing-break\"></p>", es: "<p dir=\"auto\">Desarrollo enfocado en conectar a los trabajadores trasgos con la construcción, la recolección de recursos y la defensa a través de sistemas de juego modulares.</p><p dir=\"auto\"><br class=\"trailing-break\"></p>" },
          items: [
            {
              id: "Yqnx9zdUc",
  ...
  "goblin-td": {
    ...
    development: {
      ...
      displayTitle: { en: "Development", es: "Desarrollo" },
      bodyHtml: { en: "<p dir=\"auto\">Development focused on building the systems that connect goblin workers with construction, resource gathering, and defense. The goal was to keep these systems modular while making each worker action visible in the game world.</p>", es: "<p dir=\"auto\">El desarrollo se centró en construir los sistemas que conectan a los trabajadores goblins con la construcción, la recolección de recursos y la defensa. El objetivo era mantener estos sistemas modulares y, al mismo tiempo, hacer que cada acción de los trabajadores fuera visible en el mundo del juego.</p>" },
      bodyMobileHtml: { en: "<p dir=\"auto\">Development focused on building the systems that connect goblin workers with construction, resource gathering, and defense. The goal was to keep these systems modular while making each worker action visible in the game world.</p>", es: "<p dir=\"auto\">Desarrollo centrado en la construcción de los sistemas que conectan a los trabajadores goblin con la construcción, la recolección de recursos y la defensa. El objetivo era mantener estos sistemas modulares mientras se hacía visible cada acción del trabajador en el mundo del juego.</p>" },
      subsections: [
        {
          id: "StkcXpsCe",
          displayTitle: { en: "1. Construction System", es: "1. Sistema de construcción" },
          bodyHtml: { en: "<p dir=\"auto\">Development focused on connecting goblin workers with construction, resource gathering, and defense through modular gameplay systems.</p><p dir=\"auto\"><br class=\"trailing-break\"></p>", es: "<p dir=\"auto\">Desarrollo centrado en conectar a los trabajadores trasgos con la construcción, la recolección de recursos y la defensa a través de sistemas de juego modulares.</p><p dir=\"auto\"><br class=\"trailing-break\"></p>" },
          items: [
            {
              id: "mSNHgqZhI",
              displayTitle: { en: "Construction Flow", es: "Flujo de construcción" },
              bodyHtml: { en: "<p dir=\"auto\">Building placement links grid validation, worker assignment, construction, and UI feedback into a single gameplay flow.</p>", es: "<p dir=\"auto\">La colocación de edificios vincula la validación de la cuadrícula, la asignación de trabajadores, la construcción y la retroalimentación de la interfaz de usuario en un único flujo de juego.</p>" },
              badge: { en: "01", es: "01" },
              icon: asset("si-goblin-construction.png"),
              order: 1,
            },
          ],
        },
        {
          ...
          items: [
            {
              id: "OYKY2LpOi",
              displayTitle: { en: "01 · Grid Placement", es: "01 · Colocación en la cuadrícula" },
              bodyHtml: { en: "<p dir=\"auto\">The placement system checks footprint size, tile validity, and occupancy before allowing a structure to be built.</p><p dir=\"auto\"><strong>Implementation focus</strong><br>Grid validation, footprint variants, occupancy rules, and placement feedback.</p>", es: "<p dir=\"auto\">El sistema de colocación verifica el tamaño de la huella, la validez de la baldosa y la ocupación antes de permitir que se construya una estructura.</p><p dir=\"auto\"><strong>Enfoque de la implementación</strong><br>Validación de cuadrícula, variantes de huella, reglas de ocupación y retroalimentación de colocación.</p>" },
              badge: { en: "02", es: "02" },
              icon: asset("si-placeholder.png"),
              order: 1,
            },
            {
              id: "Wk9mx9_Pf",
              displayTitle: { en: "02 · Goblin Assignment", es: "02 · Tarea del duende" },
              bodyHtml: { en: "<p dir=\"auto\">Buildings require available goblins to operate. Workers physically move to construction sites, mines, farms, and defense positions.</p><p dir=\"auto\"><strong>Implementation focus</strong><br>Worker availability, task assignment, movement, and state transitions.</p>", es: "<p dir=\"auto\">Los edificios requieren goblins disponibles para funcionar. Los trabajadores se trasladan físicamente a los sitios de construcción, minas, granjas y posiciones de defensa.</p><p dir=\"auto\"><strong>Enfoque de implementación</strong><br>Disponibilidad de trabajadores, asignación de tareas, movimiento y transiciones de estado.</p>" },
              badge: { en: "02", es: "02" },
              icon: asset("si-placeholder.png"),
              order: 1,
            },
            {
              id: "u1hqlvSek",
              displayTitle: { en: "03 · Building Lifecycle", es: "03 · Ciclo de vida del edificio" },
              bodyHtml: { en: "<p dir=\"auto\">Structures move through placement, construction, activation, and operational states, keeping gameplay and UI synchronized.</p><p dir=\"auto\"><strong>Implementation focus</strong><br>Construction states, worker integration, building activation, and UI updates.</p>", es: "<p dir=\"auto\">Las estructuras pasan por estados de colocación, construcción, activación y funcionamiento, manteniendo sincronizados el juego y la interfaz de usuario.</p><p dir=\"auto\"><strong>Enfoque de la implementación</strong><br>Estados de construcción, integración de trabajadores, activación de edificios y actualizaciones de la interfaz de usuario.</p>" },
              badge: { en: "02", es: "02" },
              icon: asset("si-placeholder.png"),
              order: 1,
            },
