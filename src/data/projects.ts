...
export const projects: Project[] = [
  {
    ...
    draft: false,
    title: { en: "Claws & Cue Balls", es: " Claws & Cue balls" },
  ...
  },
  {
    ...
    slug: "goblin-td",
    draft: false,
    title: { en: "Goblin TD", es: "Goblin TD" },
    year: { en: "2026", es: "2026" },
    tagline: { en: "A resource-driven tower defense where goblins gather, build, and protect the crystal.", es: "Un juego de tower defense impulsado por recursos donde los duendes recolectan, construyen y protegen el cristal." },
  ...
  },
  {
    ...
    role: { en: "UX Designer, Game Designer, Unity Developer", es: "Diseñadora de UX, Diseñadora de videojuegos, Desarrolladora de Unity" },
    status: "Academic project",
    featured: true,
  ...
  },
  {
    ...
    role: { en: "Level Designer, Game Designer", es: "Diseñadora de niveles, Diseñadora de juegos" },
    status: "Academic project",
    featured: true,
